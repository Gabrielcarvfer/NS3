...
void pop_mpls_act(struct datapath *dp, struct sk_buff *skb,
				  struct sw_flow_key *key, const struct action_pop_mpls *apm);

void push_mpls_act(struct datapath *dp, struct sk_buff *skb,
				   struct sw_flow_key *key, const struct action_push_mpls *apm);
...
void pt_execute_act(struct datapath *dp, struct sk_buff *skb,
