               ...
               > m_defaultEndpointsKpmTypeAndUnit =
{
    ...
    {"HO.SrcCellQual.RSRP", {INTEGER, "dBm", NOTIMPLEMENTED}},
    {"HO.SrcCellQual.RSRQ", {INTEGER, "dB", NOTIMPLEMENTED}},
    {"HO.TrgtCellQual.RSRP", {INTEGER, "dBm", NOTIMPLEMENTED}},
    {"HO.TrgtCellQual.RSRQ", {INTEGER, "dB", NOTIMPLEMENTED}},
