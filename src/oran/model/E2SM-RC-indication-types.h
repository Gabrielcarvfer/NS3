...
{
const uint8_t VALUE =
    1; ///< E2SM RC Radio Bearer Control Request's DRB QoS Configuration Request service
}

namespace QOS_FLOW_MAPPING_CONFIGURATION_REQUEST
{
const uint8_t VALUE =
    2; ///< E2SM RC Radio Bearer Control Request's QoS Flow Mapping Configuration Request service
}

namespace LOGICAL_CHANNEL_CONFIGURATION_REQUEST
{
const uint8_t VALUE =
    3; ///< E2SM RC Radio Bearer Control Request's Logical Channel Configuration Request service
}

namespace RADIO_ADMISSION_CONTROL_REQUEST
{
const uint8_t VALUE =
    4; ///< E2SM RC Radio Bearer Control Request's Radio Admission Control Request service
}

namespace DRB_TERMINATION_CONTROL_REQUEST
{
const uint8_t VALUE =
    5; ///< E2SM RC Radio Bearer Control Request's DRB Termination Control Request service
}

namespace DRB_SPLIT_RATION_CONTROL_REQUEST
{
const uint8_t VALUE =
    6; ///< E2SM RC Radio Bearer Control Request's DRB Split Ration Control Request service
}

namespace PDCP_DUPLICATION_CONTROL_REQUEST
{
const uint8_t VALUE =
    7; ///< E2SM RC Radio Bearer Control Request's PDCP Duplication Control Request service
}
} // namespace RADIO_BEARER_CONTROL_REQUEST
...
{
const uint8_t VALUE = 1; ///< E2SM RC Radio Resource Allocation Control Request's DRX Parameter
                         ///< Configuration Request service
}

namespace SR_PERIODICITY_CONFIGURATION_REQUEST
{
const uint8_t VALUE = 2; ///< E2SM RC Radio Resource Allocation Control Request's SR Periodicity
                         ///< Configuration Request service
}

namespace SPS_PARAMETERS_CONFIGURATION_REQUEST
{
const uint8_t VALUE = 3; ///< E2SM RC Radio Resource Allocation Control Request's SPS Parameters
                         ///< Configuration Request service
}

namespace CONFIGURED_GRANT_CONTROL_REQUEST
{
const uint8_t VALUE = 4; ///< E2SM RC Radio Resource Allocation Control Request's Configured Grant
                         ///< Control Request service
}

namespace CQI_TABLE_CONFIGURATION_REQUEST
{
const uint8_t VALUE = 5; ///< E2SM RC Radio Resource Allocation Control Request's CQI Table
                         ///< Configuration Request service
}

namespace SLICE_LEVEL_PRB_QUOTA_REQUEST
{
const uint8_t VALUE = 6; ///< E2SM RC Radio Resource Allocation Control Request's Slice Level PRB
                         ///< Quota Request service
}
} // namespace RADIO_RESOURCE_ALLOCATION_CONTROL_REQUEST
...
{
const uint8_t VALUE =
    1; ///< E2SM RC Connected Mode Mobility Control Request's Handover Control Request service
}

namespace CONDITIONAL_HANDOVER_CONTROL_REQUEST
{
const uint8_t VALUE = 2; ///< E2SM RC Connected Mode Mobility Control Request's Conditional Handover
                         ///< Control Request service
}

namespace DUAL_ACTIVE_PROTOCOL_STACK_HANDOVER_CONTROL_REQUEST
{
const uint8_t VALUE = 3; ///< E2SM RC Connected Mode Mobility Control Request's Dual Active Protocol
                         ///< Stack Handover Control Request service
}
} // namespace CONNECTED_MODE_MOBILITY_CONTROL_REQUEST
...
{
const uint8_t VALUE =
    1; ///< E2SM RC Radio Access Control Request's UE Admission Control Request service
}

namespace RACH_BACKOFF_CONTROL_REQUEST
{
const uint8_t VALUE =
    2; ///< E2SM RC Radio Access Control Request's RACH Backoff Control Request service
}

namespace ACCESS_BARRING_CONTROL_REQUEST
{
const uint8_t VALUE =
    3; ///< E2SM RC Radio Access Control Request's Access Barring Control Request service
}
...
{
const uint8_t VALUE = 1; ///< E2SM RC Dual Connectivity Control Request's DC Secondary Node Addition
                         ///< Control Request service
}

namespace DC_SECONDARY_NODE_MODIFICATION_AND_RELEASE_CONTROL_REQUEST
{
const uint8_t VALUE = 2; ///< E2SM RC Dual Connectivity Control Request's DC Secondary Node
                         ///< Modification and Release Control Request service
}

namespace DC_PSCELL_CHANGE_CONTROL_REQUEST
{
const uint8_t VALUE =
    3; ///< E2SM RC Dual Connectivity Control Request's DC PSCell Change Control Request service
}

namespace DC_SECONDARY_NODE_CHANGE_CONTROL_REQUEST
{
const uint8_t VALUE = 4; ///< E2SM RC Dual Connectivity Control Request's DC Secondary Node Change
                         ///< Control Request service
}
...
{
const uint8_t VALUE =
    5; ///< E2SM RC Dual Connectivity Control Request's DC DRB Termination Control Request service
}
} // namespace DUAL_CONNECTIVITY_CONTROL_REQUEST
...
{
const uint8_t VALUE = 1; ///< E2SM RC Carrier Aggregation Control Request's CA Secondary Cell
                         ///< Addition Control Request service
}

namespace CA_SECONDARY_CELL_MODIFICATION_AND_RELEASE_CONTROL_REQUEST
{
const uint8_t VALUE = 2; ///< E2SM RC Carrier Aggregation Control Request's CA Secondary Cell
                         ///< Modification and Release Control Request service
}
} // namespace CARRIER_AGGREGATION_CONTROL_REQUEST
...
{
const uint8_t VALUE =
    1; ///< E2SM RC Idle Mode Mobility Control Request's Cell Reselection Priority Request service
}
} // namespace IDLE_MODE_MOBILITY_CONTROL_REQUEST
...
typedef struct
{
    ...
    union {
        ...
        {
            uint16_t
                eventTriggerConditionID; ///< Condition ID for event that triggered the indication
...
typedef struct
{
    ...
    union {
        ...
        uint8_t raw[1000]; ///< E2SM RC Indication Message raw contents todo: workaround this
                           ///< arbitrary limit
