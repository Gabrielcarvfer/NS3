...
enum RIC_INSERT_SERVICE_STYLES
{
    RADIO_BEARER_CONTROL_REQUEST = 1,
    RADIO_RESOURCE_ALLOCATION_CONTROL_REQUEST,
    CONNECTED_MODE_MOBILITY_CONTROL_REQUEST,
    RADIO_ACCESS_CONTROL_REQUEST,
    DUAL_CONNECTIVITY_CONTROL_REQUEST,
    CARRIER_AGGREGATION_CONTROL_REQUEST,
    IDLE_MODE_MOBILITY_CONTROL_REQUEST,
    MULTIPLE_ACTIONS_CONTROL_REQUEST,
};
