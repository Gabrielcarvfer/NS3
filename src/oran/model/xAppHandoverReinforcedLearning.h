#ifndef NS3_XAPP_HANDOVER_REINFORCED_LEARNING_H
#define NS3_XAPP_HANDOVER_REINFORCED_LEARNING_H

#include "xAppHandover.h"

/**
 * \ingroup oran
 * ns3::oran::xAppHandoverReinforcedLearning declaration.
 */
...
/**
 * \ingroup oran
 * \class xAppHandoverReinforcedLearning
 * \brief An implementation of a Handover xApp using
 * the MaxRsrq strategy
 */
class xAppHandoverReinforcedLearning : public xAppHandover
{
  public:
    /**
     * \brief Constructor of xAppHandoverReinforcedLearning.
     * \param [in] initiateHandovers Set flag to make the xApp initiate the handovers of E2 Nodes.
     */
    xAppHandoverReinforcedLearning(bool initiateHandovers = false);
    /**
     * \brief Constructor of xAppHandoverReinforcedLearning.
...
#endif // NS3_XAPP_HANDOVER_REINFORCED_LEARNING_H
