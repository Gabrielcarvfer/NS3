...
main()
{
    ...
    Json test = Json::parse(
        "{\"PUBLIC_RPC\":{\"BODY\":{\"KEY\":\"value\"},\"DEST_ENDPOINT\":\"/E2Node/0/teste\"}}");
    ...
    // Publishing remoto (abrir socket, mandar requisição para nó 0, repostar a partir do nó 0 para
    // destinatários) e2n1.PublishToEndpoint("/E2Node/1/teste2", "{\"pimba\" : \"true\"}");
