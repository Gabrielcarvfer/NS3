...
PhyTxStatsCalculator::DlPhyTransmission (PhyTransmissionStatParameters params)
{
  ...
  //m_dlTxOutFile << Simulator::Now ().GetNanoSeconds () / (double) 1e9 << "\t";
  ...
  m_dlTxOutFile << (uint32_t) params.m_ccId << "\n";
}
...
PhyTxStatsCalculator::UlPhyTransmission (PhyTransmissionStatParameters params)
{
  ...
  //m_ulTxOutFile << Simulator::Now ().GetNanoSeconds () / (double) 1e9 << "\t";
  ...
  m_ulTxOutFile << (uint32_t) params.m_ccId << "\n";
}
