...
PhyRxStatsCalculator::DlPhyReception (PhyReceptionStatParameters params)
{
  ...
  //m_dlRxOutFile << Simulator::Now ().GetNanoSeconds () / (double) 1e9 << "\t";
  ...
  m_dlRxOutFile << (uint32_t) params.m_ccId << "\n";
}
...
PhyRxStatsCalculator::UlPhyReception (PhyReceptionStatParameters params)
{
  ...
  //m_ulRxOutFile << Simulator::Now ().GetNanoSeconds () / (double) 1e9 << "\t";
  ...
  m_ulRxOutFile << (uint32_t) params.m_ccId << "\n";
}
