...
public:
  ...
  void SendCognitiveMessage(Ptr<SpectrumSignalParameters> rxParams, uint32_t UnexpectedAccessBitmap, bool falsePositive); //todo: implement this properly through the SAP
