...
#ifndef NN_FF_MAC_SCHEDULER_H
#define NN_FF_MAC_SCHEDULER_H
...
class NnFfMacScheduler : public FfMacScheduler
{
public:
  /**
   * \brief Constructor
  ...
  /// allow MemberCschedSapProvider<NnFfMacScheduler> class friend access
  friend class MemberCschedSapProvider<NnFfMacScheduler>;
  /// allow MemberSchedSapProvider<NnFfMacScheduler> class friend access
  friend class MemberSchedSapProvider<NnFfMacScheduler>;
...
private:
  ...
  */
  ...
  std::string m_CqaMetric; ///< NN metric name
  ...
  std::map<size_t, std::ofstream*> outputfileMap;
