...
// 4. Set mobility of the nodes
    ...
    mobility.Install(wifiMovingStaNodes.Get(2));
    ...
    Ptr<ConstantVelocityMobilityModel> mob = wifiMovingStaNodes.Get(2)->GetObject<ConstantVelocityMobilityModel>();
    mob->SetVelocity(Vector(15.0, 3.0, 0.0));
