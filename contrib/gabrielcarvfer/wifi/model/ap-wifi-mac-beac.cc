...
namespace ns3 {
    ...
    ApWifiMacBeac::GetTypeId (void)
    {
      static TypeId tid = TypeId ("ns3::ApWifiMacBeac")
              ...
              .AddAttribute ("RifsMode", "If non-HT STAs are detected, whether to force RIFS to be disabled within the BSS."
                             ...
                             BooleanValue (true),
                             MakeBooleanAccessor (&ApWifiMacBeac::m_disableRifs),
                             MakeBooleanChecker ())
      ;
      return tid;
    }
    ...
    void
    ApWifiMacBeac::SetWifiRemoteStationManager (const Ptr<WifiRemoteStationManager> stationManager)
    {
    ...
    bool
    ApWifiMacBeac::IsNonGfHtStasPresent (void) const
    {
    ...
    uint8_t
    ApWifiMacBeac::GetVhtOperationalChannelWidth (void) const
    {
    ...
    HtOperation
    ApWifiMacBeac::GetHtOperation (void) const
    {
      NS_LOG_FUNCTION (this);
    ...
    VhtOperation
    ApWifiMacBeac::GetVhtOperation (void) const
    {
      NS_LOG_FUNCTION (this);
    ...
    bool
    ApWifiMacBeac::GetRifsMode (void) const
    {
      bool rifsMode = false;
