...
#include "sta-wifi-mac-chronos.h"
#include "ns3/log.h"
...
NS_LOG_COMPONENT_DEFINE ("StaWifiMacChronos");

NS_OBJECT_ENSURE_REGISTERED (StaWifiMacChronos);

TypeId
StaWifiMacChronos::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::StaWifiMacChronos")
    .SetParent<RegularWifiMac> ()
    .SetGroupName ("Wifi")
    .AddConstructor<StaWifiMacChronos> ()
    .AddAttribute ("ProbeRequestTimeout", "The interval between two consecutive probe request attempts.",
                   TimeValue (Seconds (0.05)),
                   MakeTimeAccessor (&StaWifiMacChronos::m_probeRequestTimeout),
                   MakeTimeChecker ())
    .AddAttribute ("AssocRequestTimeout", "The interval between two consecutive assoc request attempts.",
                   TimeValue (Seconds (0.5)),
                   MakeTimeAccessor (&StaWifiMacChronos::m_assocRequestTimeout),
                   MakeTimeChecker ())
    .AddAttribute ("MaxMissedBeacons",
                   "Number of beacons which much be consecutively missed before "
                   "we attempt to restart association.",
                   UintegerValue (10),
                   MakeUintegerAccessor (&StaWifiMacChronos::m_maxMissedBeacons),
    ...
    .AddAttribute ("ActiveProbing",
                   ...
                   BooleanValue (false),
                   MakeBooleanAccessor (&StaWifiMacChronos::SetActiveProbing, &StaWifiMacChronos::GetActiveProbing),
                   MakeBooleanChecker ())
    .AddTraceSource ("Assoc", "Associated with an access point.",
                     MakeTraceSourceAccessor (&StaWifiMacChronos::m_assocLogger),
                     "ns3::Mac48Address::TracedCallback")
    .AddTraceSource ("DeAssoc", "Association with an access point lost.",
                     MakeTraceSourceAccessor (&StaWifiMacChronos::m_deAssocLogger),
                     "ns3::Mac48Address::TracedCallback")
  ;
  return tid;
}

StaWifiMacChronos::StaWifiMacChronos ()
...
void
StaWifiMacChronos::SetMaxMissedBeacons (uint32_t missed)
{
...
void
StaWifiMacChronos::SetProbeRequestTimeout (Time timeout)
{
...
void
StaWifiMacChronos::SetAssocRequestTimeout (Time timeout)
{
  NS_LOG_FUNCTION (this << timeout);
...
void
StaWifiMacChronos::StartActiveAssociation (void)
{
  NS_LOG_FUNCTION (this);
...
void
StaWifiMacChronos::SetActiveProbing (bool enable)
{
  NS_LOG_FUNCTION (this << enable);
  if (enable)
    {
      Simulator::ScheduleNow (&StaWifiMacChronos::TryToEnsureAssociated, this);
    }
  else
    {
...
bool StaWifiMacChronos::GetActiveProbing (void) const
{
  return m_activeProbing;
}

void
StaWifiMacChronos::SendProbeRequest (void)
{
  NS_LOG_FUNCTION (this);
  WifiMacHeader hdr;
  hdr.SetProbeReq ();
  ...
  m_probeRequestEvent = Simulator::Schedule (m_probeRequestTimeout,
                                             &StaWifiMacChronos::ProbeRequestTimeout, this);
}

void
StaWifiMacChronos::SendAssociationRequest (void)
{
  ...
  m_assocRequestEvent = Simulator::Schedule (m_assocRequestTimeout,
                                             &StaWifiMacChronos::AssocRequestTimeout, this);
}

void
StaWifiMacChronos::TryToEnsureAssociated (void)
{
  NS_LOG_FUNCTION (this);
  switch (m_state)
    {
...
void
StaWifiMacChronos::AssocRequestTimeout (void)
{
  NS_LOG_FUNCTION (this);
...
void
StaWifiMacChronos::ProbeRequestTimeout (void)
{
  NS_LOG_FUNCTION (this);
  SetState (WAIT_PROBE_RESP);
  SendProbeRequest ();
...
void
StaWifiMacChronos::MissedBeacons (void)
{
  NS_LOG_FUNCTION (this);
  if (m_beaconWatchdogEnd > Simulator::Now ())
    {
      ...
      m_beaconWatchdog = Simulator::Schedule (m_beaconWatchdogEnd - Simulator::Now (),
                                              &StaWifiMacChronos::MissedBeacons, this);
      return;
    }
...
void
StaWifiMacChronos::RestartBeaconWatchdog (Time delay)
{
  ...
  if (Simulator::GetDelayLeft (m_beaconWatchdog) < delay
      && m_beaconWatchdog.IsExpired ())
    {
      ...
      m_beaconWatchdog = Simulator::Schedule (delay, &StaWifiMacChronos::MissedBeacons, this);
    }
}

bool
StaWifiMacChronos::IsAssociated (void) const
{
  return m_state == ASSOCIATED;
}

bool
StaWifiMacChronos::IsWaitAssocResp (void) const
{
  return m_state == WAIT_ASSOC_RESP;
}

void
StaWifiMacChronos::Enqueue (Ptr<const Packet> packet, Mac48Address to)
{
...
void
StaWifiMacChronos::Receive (Ptr<Packet> packet, const WifiMacHeader *hdr)
{
...
SupportedRates
StaWifiMacChronos::GetSupportedRates (void) const
{
...
StaWifiMacChronos::GetCapabilities (void) const
{
...
void
StaWifiMacChronos::SetState (MacState value)
{
  if (value == ASSOCIATED
      && m_state != ASSOCIATED)
    {
...
void
StaWifiMacChronos::SetEdcaParameters (AcIndex ac, uint8_t cwMin, uint8_t cwMax, uint8_t aifsn, Time txopLimit)
{
