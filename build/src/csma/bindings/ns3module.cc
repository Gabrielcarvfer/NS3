...
static PyMethodDef PyNs3CsmaNetDevice_methods[] = {
    ...
    {(char *) "GetQueue", (PyCFunction) _wrap_PyNs3CsmaNetDevice_GetQueue, METH_NOARGS, "GetQueue()\n\n" },
    ...
    {(char *) "SetQueue", (PyCFunction) _wrap_PyNs3CsmaNetDevice_SetQueue, METH_KEYWORDS|METH_VARARGS, "SetQueue(queue)\n\ntype: queue: ns3::Ptr< ns3::Queue >" },
