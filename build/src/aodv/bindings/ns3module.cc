...
static PyMethodDef PyNs3AodvRoutingProtocol_methods[] = {
    ...
    {(char *) "PrintRoutingTable", (PyCFunction) _wrap_PyNs3AodvRoutingProtocol_PrintRoutingTable, METH_KEYWORDS|METH_VARARGS, "PrintRoutingTable(stream)\n\ntype: stream: ns3::Ptr< ns3::OutputStreamWrapper >" },
...
static PyMethodDef PyNs3AodvRoutingTableEntry_methods[] = {
    ...
    {(char *) "SetBalcklistTimeout", (PyCFunction) _wrap_PyNs3AodvRoutingTableEntry_SetBalcklistTimeout, METH_KEYWORDS|METH_VARARGS, "SetBalcklistTimeout(t)\n\ntype: t: ns3::Time" },
