...
_wrap_PyNs3VirtualNetDevice_AddLinkChangeCallback(PyNs3VirtualNetDevice *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    PyObject *callback;
    ns3::Ptr<PythonCallbackImpl3> callback_cb_impl;
    ...
    callback_cb_impl = ns3::Create<PythonCallbackImpl3> (callback);
...
static PyMethodDef PyNs3VirtualNetDevice_methods[] = {
    ...
    {(char *) "AddLinkChangeCallback", (PyCFunction) _wrap_PyNs3VirtualNetDevice_AddLinkChangeCallback, METH_KEYWORDS|METH_VARARGS, "AddLinkChangeCallback(callback)\n\ntype: callback: ns3::Callback< void, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >" },
