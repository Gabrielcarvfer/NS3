...
PyObject *
_wrap_PyNs3SixLowPanNetDevice_AddLinkChangeCallback(PyNs3SixLowPanNetDevice *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    PyObject *callback;
...
static PyMethodDef PyNs3SixLowPanNetDevice_methods[] = {
    ...
    {(char *) "AddLinkChangeCallback", (PyCFunction) _wrap_PyNs3SixLowPanNetDevice_AddLinkChangeCallback, METH_KEYWORDS|METH_VARARGS, "AddLinkChangeCallback(callback)\n\ntype: callback: ns3::Callback< void, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >" },
