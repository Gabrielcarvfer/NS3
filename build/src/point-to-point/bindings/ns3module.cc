...
static PyMethodDef PyNs3PointToPointNetDevice_methods[] = {
    ...
    {(char *) "GetQueue", (PyCFunction) _wrap_PyNs3PointToPointNetDevice_GetQueue, METH_NOARGS, "GetQueue()\n\n" },
    ...
    {(char *) "SetQueue", (PyCFunction) _wrap_PyNs3PointToPointNetDevice_SetQueue, METH_KEYWORDS|METH_VARARGS, "SetQueue(queue)\n\ntype: queue: ns3::Ptr< ns3::Queue >" },
